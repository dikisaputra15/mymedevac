...
<div class="card">
   ...
   <div class="row">
    ...
    <div class="col-md-3">
        <div class="card mb-3">
            <div class="card-header fw-bold"><img src="https://img.freepik.com/premium-vector/malaysia-circle-flag-icon-digital-vector-illustration_1143296-3649.jpg" style="width: 30px; height: 30px;"> Domestic</div>
