               ...
               <div class="form-check form-check-inline police-option {{ $police->category == 'Royal Malaysian Police Headquarters (Police HQ)' ? 'selected' : '' }}">
                ...
                <div class="form-check form-check-inline police-option {{ $police->category == 'State police contingent headquarters (IPK)' ? 'selected' : '' }}">
                    <input class="form-check-input category-radio"
                        type="radio"
                        name="category"
                        value="State police contingent headquarters (IPK)"
                        data-icon="{{ asset('images/Layer2.png') }}"
                        {{ $police->category == 'State police contingent headquarters (IPK)' ? 'checked' : '' }}>
                    <img src="{{ asset('images/Layer2.png') }}" width="16">
                    <label>State police contingent headquarters (IPK)</label>
                </div>

                <div class="form-check form-check-inline police-option {{ $police->category == 'District Police Force (IPD)' ? 'selected' : '' }}">
                    <input class="form-check-input category-radio"
                        type="radio"
                        name="category"
                        value="District Police Force (IPD)"
                        data-icon="{{ asset('images/Layer3.png') }}"
                        {{ $police->category == 'District Police Force (IPD)' ? 'checked' : '' }}>
