         ...
         <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="form-check form-check-inline">
                 ...
                 <div class="form-check form-check-inline">
                    <input class="form-check-input category-radio" type="radio" name="category" value="State police contingent headquarters (IPK)" data-icon="{{ asset('images/Layer2.png') }}">
                    <img src="{{ asset('images/Layer2.png') }}" style="width:12px; height:12px;">
                    <label class="form-check-label">State police contingent headquarters (IPK)</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input category-radio" type="radio" name="category" value="District Police Force (IPD)" data-icon="{{ asset('images/Layer3.png') }}">
                    <img src="{{ asset('images/Layer3.png') }}" style="width:12px; height:12px;">
                    <label class="form-check-label">District Police Force (IPD)</label>
                </div>
